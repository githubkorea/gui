...
//					UIManager.setLookAndFeel("javax.swing.plaf.metal.MetalLookAndFeel");
	...
	public JFileChooserTest() {
		...
		JLabel lblNewLabel = new JLabel("파일선택기");
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(btn==btnOpen) {  // open누르면 open다이얼로그  save면 save 다이얼로그
			...
			FileNameExtensionFilter filter2 = new FileNameExtensionFilter("이미지 파일","jpg","png","gif");
