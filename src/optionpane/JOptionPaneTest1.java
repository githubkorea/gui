...
public class JOptionPaneTest1 extends JFrame implements ActionListener {
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(btn==btnConfirm) {
//			JOptionPane.showConfirmDialog(getParent(), "대화상자만들기");   >>>> 기본                 
	//		창 하나 만들어서 확인 버튼이 닫기역할           아이콘이 인포메이션메시지 모양
			JOptionPane.showConfirmDialog(getParent(), "대화상자만들기","대화상자",
